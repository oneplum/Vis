...
static std::array<uint16_t,256> edgeTable = {
...
static std::array<std::array<uint8_t,2>,12> edgeToVertexTable = {{
  {0,1},
  {1,2},
  {2,3},
  {3,0},
...
static const std::array<std::initializer_list<uint8_t>, 256> trisTable = {{
  {},
  {0, 8, 3},
  {0, 1, 9},
  {1, 8, 3, 9, 8, 1},
